...
class RandomUserAgent {
    companion object {
        private val uaMap: MutableMap<String, Array<String>> = HashMap()
        private val freqMap: MutableMap<String, Double> = HashMap()
        private val browsers: Array<String> = arrayOf<String>("Internet Explorer", "Firefox", "Chrome", "Safari", "Opera")
        init {
        ...
        fun randomUserAgent(): String {
            val randBrowser: String = browsers[(floor(Math.random() * browsers.size)).toInt()]
            val userAgents = uaMap[randBrowser]
